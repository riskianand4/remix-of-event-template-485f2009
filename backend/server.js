...
const productMetadataRoutes = require("./routes/productMetadata");
const stockRoutes = require("./routes/stock");
const assetRoutes = require("./routes/assets");
const assetMetadataRoutes = require("./routes/assetMetadata");
...
app.use("/api/products/metadata", auth, productMetadataRoutes);
...
// Asset routes - metadata MUST be registered before main assets route
app.use("/api/assets/metadata", auth, assetMetadataRoutes);
app.use(
  "/api/assets",
  auth,
...
app.use(
  "/api/technicians",
  auth,
  logAdminActivity("Accessed technician management"),
  technicianRoutes
);
app.use(
  "/api/interruption-reports",
  auth,
  logAdminActivity("Accessed interruption reports"),
  interruptionReportRoutes
);
...
app.listen(PORT, () => {
  ...
  console.log(`Health check: https://api.inventori.telnet.id/health`);
});
