...
export const AddAssetDialog: React.FC<AddAssetDialogProps> = ({
  ...
  const handleSave = async () => {
    ...
    const asset: Omit<Asset, "id" | "createdAt" | "updatedAt"> = {
      ...
      purchaseDate: new Date(formData.purchaseDate).toISOString().split("T")[0],
      ...
      <DialogContent className="sm:max-w-[600px]">
        ...
        <div className="grid gap-3 sm:gap-4 py-3 sm:py-4">
          ...
          <div className="space-y-2">
            ...
            <Popover open={categoryOpen} onOpenChange={setCategoryOpen}>
              <PopoverTrigger asChild>
                ...
                >
                  {formData.category || "Pilih kategori asset..."}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label htmlFor="condition" className="text-xs md:text-sm">
                Kondisi
              </Label>
              <Select
          ...
          <div className="grid grid-cols-2 gap-4">
                ...
                <PopoverTrigger asChild>
                  ...
                  >
                    ...
                    {formData.purchaseDate ? (
                      format(formData.purchaseDate, "dd MMMM yyyy", {
                        locale: id,
                      })
                    ) : (
            ...
            <div className="space-y-2">
              <Label htmlFor="purchasePrice" className="text-xs md:text-sm">
                Harga Pembelian (Rp) *
              </Label>
              <Input
                id="purchasePrice"
