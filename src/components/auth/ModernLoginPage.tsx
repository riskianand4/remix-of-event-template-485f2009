...
const ModernLoginPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      } else if (typeof result === 'object' && result.requiresEmailVerification) {
        // Show email verification dialog
        setVerificationEmail(result.email);
        setVerificationUserName(result.userName || '');
  ...
  return (
    <div className="min-h-screen bg-muted/10 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        {/* Dark Overlay - always show since login is always dark */}
        ...
        >
          <div className="text-center lg:text-left">
            ...
            >
              {/* Icon */}
              <motion.div
                className="flex items-center justify-center w-14 h-14  rounded-2xl shadow-glow"
        ...
        >
          ...
          <EmailVerificationDialog
            ...
            onVerificationComplete={() => {
              ...
              toast.success('Email terverifikasi! Silakan login kembali.');
            }}
          />
        </motion.div>
      </div>
