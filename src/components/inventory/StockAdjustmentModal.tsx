  ...
  return <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="rounded-md max-w-[360px] md:max-w-xl sm:max-w-2xl  mx-0">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                <Button type="button" variant="outline" size="sm" onClick={() => setStockAdjustment(prev => prev - 1)} disabled={newStock <= 0}>
                  <TrendingDown className="w-4 h-4" />
                </Button>
                <Input id="adjustment" type="number" value={stockAdjustment} onChange={e => setStockAdjustment(parseInt(e.target.value) || 0)} className="text-center" placeholder="0" />
                <Button type="button" variant="outline" size="sm" onClick={() => setStockAdjustment(prev => prev + 1)}>
            ...
            <div className="space-y-2">
              ...
              <Textarea id="reason" value={reason} onChange={e => setReason(e.target.value)} placeholder="Masukkan alasan penyesuaian stok (wajib diisi)..." rows={3} />
            </div>
          </div>

          {/* New Stock Status Preview */}
          {stockAdjustment !== 0 && <div className="p-3 border rounded-lg">
        ...
        <DialogFooter className="flex gap-2">
          ...
          <Button type="button" onClick={handleSubmit} disabled={stockAdjustment === 0 || !reason.trim()}>
            Simpan Penyesuaian
          </Button>
        </DialogFooter>
      </DialogContent>
