...
const StockMovementHistory = () => {
  ...
  const getMovementBadge = (type: string) => {
    ...
    return <Badge className={variants[type] || 'bg-gray-100 text-gray-800 border-gray-200'}>
        {type.toUpperCase()}
      </Badge>;
  };
  const filteredMovements = movements.filter(movement => {
    ...
    const matchesSearch = productName.toLowerCase().includes(searchTerm.toLowerCase()) || productSku.toLowerCase().includes(searchTerm.toLowerCase()) || movement.reason.toLowerCase().includes(searchTerm.toLowerCase());
  ...
  return <div className="space-y-6">
        ...
        <CardContent>
          <div className="flex flex-col sm:flex-row gap-4 mb-6">
            <div className="relative flex-1">
              ...
              <Input placeholder="Search by product name, code, or reason..." value={searchTerm} onChange={e => setSearchTerm(e.target.value)} className="pl-10" />
            </div>
          ...
          <div className="border rounded-lg overflow-x-auto">
            <Table className="min-w-[1200px]">
              ...
              <TableBody>
                {filteredMovements.map((movement, index) => <motion.tr key={movement._id} initial={{
                opacity: 0,
                y: 20
              }} animate={{
                opacity: 1,
                ...
                delay: index * 0.05
                    ...
                    <TableCell>
                      <div className="flex gap-1">
                        <Button variant="ghost" size="sm" onClick={() => handleViewDetail(movement)}>
                        ...
                        {user?.role === 'superadmin' && <>
                            ...
                            <Button variant="ghost" size="sm" onClick={() => handleDeleteClick(movement._id)}>
      ...
      {/* Edit Modal */}
      <EditStockMovementModal isOpen={editModalOpen} onClose={() => {
      setEditModalOpen(false);
      setSelectedMovement(null);
    }} movement={selectedMovement} onUpdate={handleUpdate} />
      ...
      <Dialog open={detailDialogOpen} onOpenChange={setDetailDialogOpen}>
        <DialogContent className="rounded-md max-w-[360px] md:max-w-xl sm:max-w-2xl  mx-0 ">
          ...
          {movementDetail && <div className="space-y-6">
              ...
              <div className="border rounded-lg p-4 bg-muted/30">
                ...
                <div className="space-y-4">
                  ...
                  {movementDetail.reference && <div className="space-y-1">
                  ...
                  {movementDetail.notes && <div className="space-y-1">
