  ...
  return <SidebarProvider defaultOpen={true}>
      <div className="min-h-screen flex w-full bg-background">
        ...
        <div className="flex-1 flex flex-col ml-60">
          ...
          duration: 0.3
        }} className="sm:h-14  h-[89px] lg:h-[89px] border-b border-border/50 bg-card/50 backdrop-blur-xl flex items-center justify-between px-2 sm:px-4 lg:px-6">
          ...
          <main className="flex-1 p-4 lg:p-6 overflow-hidden">
            ...
            <WelcomeSection className="mb-6 w-full" />
            <motion.div initial={{
            opacity: 0,
            y: 20
          }} animate={{
