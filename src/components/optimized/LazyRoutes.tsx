...
// Import technician components directly to avoid lazy loading issues
import TechnicianPage from '@/pages/TechnicianPage';
import TechnicianReportsPage from '@/pages/technician/TechnicianReportsPage';

export const LazyTechnicianPage = TechnicianPage;
export const LazyTechnicianReports = TechnicianReportsPage;
export const LazySupervisorDashboard = lazy(() => import('@/pages/SupervisorDashboard'));