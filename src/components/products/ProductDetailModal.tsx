                ...
                <div className="border rounded-lg p-4 bg-muted/30">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-base bg-background rounded px-2 py-1 border">{product.sku}</p>
                    </div>
                    <div className="space-y-1">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-lg font-bold text-primary bg-background rounded px-2 py-1 border">{(product as any).unit || 'pcs'}</p>
                    </div>
                  </div>
                </div>
                ...
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-lg font-bold">{product.stock} {(product as any).unit || 'pcs'}</p>
                    </div>
