        ...
        <div className="space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <Input id="cluster" value={formData.cluster || ''} onChange={e => handleInputChange('cluster', e.target.value)} placeholder="Masukkan nama cluster" />
            </div>

            {/* STO */}
            <div className="space-y-2">
              <Label htmlFor="sto">STO <span className="text-red-500">*</span></Label>
              <Input id="sto" value={formData.sto || ''} onChange={e => handleInputChange('sto', e.target.value)} placeholder="Masukkan nama STO" />
            </div>

            {/* Customer Name */}
            <div className="space-y-2">
              <Label htmlFor="customerName">Nama Pelanggan <span className="text-red-500">*</span></Label>
              <Input id="customerName" value={formData.customerName || ''} onChange={e => handleInputChange('customerName', e.target.value)} placeholder="Masukkan nama pelanggan" />
            </div>

            {/* Customer Phone */}
            <div className="space-y-2">
              <Label htmlFor="customerPhone">Nomor Telepon <span className="text-red-500">*</span></Label>
              <Input id="customerPhone" type="tel" value={formData.customerPhone || ''} onChange={e => handleInputChange('customerPhone', e.target.value)} placeholder="Masukkan nomor telepon" />
            </div>
          ...
          <div className="space-y-2">
            ...
            <Textarea id="address" value={formData.address || ''} onChange={e => handleInputChange('address', e.target.value)} placeholder="Masukkan alamat lengkap pelanggan" rows={3} />
          </div>
