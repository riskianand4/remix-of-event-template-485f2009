...
import { BarChart3, FileText, Plus, Users, Settings, ArrowLeft, Database, PieChart, TrendingUp, Wrench } from 'lucide-react';
      ...
      <SidebarContent className="px-4 py-2 flex flex-col h-full">
        ...
        <div className="mt-auto pt-4 px-2 border-t border-border/50">
          <Button
            ...
            onClick={() => !isCS && (window.location.href = '/')}
            disabled={isCS}
          >
            <ArrowLeft className="h-5 w-5" />
            {!collapsed && (
              <span className="font-medium">
                {isCS ? 'Akses Inventori Terbatas' : 'Kembali ke Inventori'}
              </span>
            )}
          </Button>
        </div>
