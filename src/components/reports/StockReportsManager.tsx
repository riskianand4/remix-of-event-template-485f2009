...
const StockReportsManager = () => {
  ...
  return <div className="min-h-screen bg-muted/10 p-3 sm:p-4 lg:p-0">
      <motion.div initial={{
      opacity: 0,
      y: 20
    }} animate={{
      ...
      y: 0
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
          <div className="w-full sm:w-auto">
            <h1 className="text-xl sm:text-2xl lg:text-2xl font-bold text-foreground mb-2 sm:mb-0">Laporan Stok Barang</h1>
              ...
              <div className="overflow-x-auto">
                ...
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="text-right w-[100px] sm:w-[120px]">Unit</TableHead>
                    ...
                    <TableHead className="text-right w-[120px] sm:w-[140px]">Total Unit</TableHead>
                ...
                <TableBody>
                  {filteredData.map(item => <TableRow key={item.id}>
                      <TableCell className="text-xs sm:text-sm">{item.sku}</TableCell>
                      <TableCell>
                        <div>
