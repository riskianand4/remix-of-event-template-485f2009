  ...
  const setupSteps = [
    {
      ...
      description: `Make sure your Node.js backend is running at ${ENV.API_BASE_URL}`,
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-muted-foreground">
          Follow these steps to connect your frontend to your backend at {ENV.API_BASE_URL}
        </p>
      </motion.div>
          ...
          <CardContent className="space-y-3">
            <div className="text-sm">
              ...
              <ul className="space-y-1 text-muted-foreground">
                ...
                <li>• Check that CORS is configured to allow {ENV.IS_DEVELOPMENT ? 'localhost:8080' : 'inventori.telnet.id'}</li>
