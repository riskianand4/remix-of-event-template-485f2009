...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background/95 backdrop-blur-xl border-white/10 p-6 shadow-2xl shadow-black/50 transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
