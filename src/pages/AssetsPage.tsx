...
import { Package, Plus, TrendingUp, AlertCircle, Clock, DollarSign, Activity, Download, Upload } from 'lucide-react';
...
import { ImportAssetDialog } from '@/components/assets/ImportAssetDialog';
...
const AssetsPage = () => {
  ...
  return (
    <ErrorBoundary>
      <MainLayout>
        <div className="w-full max-w-none overflow-x-hidden space-y-4 sm:space-y-6  sm:p-0 pb-16 sm:pb-20">
          ...
          <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-4 sm:space-y-6">
            ...
            <motion.div variants={itemVariants} className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-4">
              ...
              <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                ...
                {canEdit && (
                  <>
                    <Button onClick={() => setShowImportDialog(true)} variant="outline" className="glass w-full sm:w-auto" size="sm">
            ...
            <motion.div variants={itemVariants} className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
              ...
              <Card className="bg-accent/10 border-accent/20">
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 sm:pb-1">
                  ...
                  <span className="h-3 w-3 sm:h-4 sm:w-4 text-muted-foreground" >Rp</span> 
                </CardHeader>
                <CardContent className="pb-2 sm:pb-3">
