...
const mapFrontendAssetToBackend = (frontendAsset: Partial<Asset>): any => {
  ...
  if (frontendAsset.purchaseDate) {
    backendAsset.purchaseDate = frontendAsset.purchaseDate instanceof Date 
      ? frontendAsset.purchaseDate.toISOString() 
      : frontendAsset.purchaseDate;
  }
